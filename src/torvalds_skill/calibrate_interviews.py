...
Usage:
    python -m torvalds_skill.calibrate_interviews
    python -m torvalds_skill.calibrate_interviews --email-moves data/moves.jsonl --interview-moves data/interview_moves.jsonl --output data/calibration.json
"""
